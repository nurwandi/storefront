...
class Product(models.Model):
    # createNoPrimaryKey = models.CharField(max_length=10, primary_key=True)
    title = models.CharField(max_length=255)
    ...
    # product can have many collections
...
class Order_item(models.Model):
    ...
    quantity = models.PositiveIntegerField() # small positive number
